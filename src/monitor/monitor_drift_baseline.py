...
"""Lí do phải kiểm tra drift giữa dữ liệu mới và gốc (dữ liệu huấn luyện),
thay vì dữ liệu mới và cũ hơn (ví dụ dữ liệu tuần trước) vì dữ liệu gốc là baseline chuẩn,
model được huấn luyện trên đó nên dễ phát hiện drift hơn."""
